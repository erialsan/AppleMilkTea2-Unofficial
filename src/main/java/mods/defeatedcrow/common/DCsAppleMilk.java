...
public class DCsAppleMilk {
    ...
    public static final String[] TEX_PASS = new String[] { "defeatedcrow:", "defeatedcrow:x32/",
        "defeatedcrow:x32alt/" };
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        Configuration cfg2 = new Configuration(
            new File(event.getModConfigurationDirectory(), getModID() + "-cocktail.cfg"));
    ...
    public void init(FMLInitializationEvent event) throws IOException {
        ...
        EntityRegistry
            .registerModEntity(EntityMelonBomb.class, "compressedMelon", DCsConfig.entityIdMelon, this, 250, 5, true);
        EntityRegistry.registerModEntity(
            EntitySilkyMelon.class,
            "compressedSilkyMelon",
            DCsConfig.entityIdSilkMelon,
            this,
            250,
            5,
            true);
        EntityRegistry
            .registerModEntity(EntityKinoko.class, "mushroomBox", DCsConfig.entityIdKinoko, this, 250, 5, true);
        EntityRegistry
            .registerModEntity(EntityStunEffect.class, "stunEntity", DCsConfig.entityIdStun, this, 250, 5, true);
        EntityRegistry.registerModEntity(
            EntityIllusionMobs.class,
            "illusionCreeper",
            DCsConfig.entityIdIllusion,
            this,
            250,
            5,
            true);
        EntityRegistry.registerModEntity(
            EntityAnchorMissile.class,
            "anchorMissile",
            DCsConfig.entityIdMissile,
            this,
            250,
            5,
            true);
        EntityRegistry
            .registerModEntity(EntityYuzuBullet.class, "yuzuBullet", DCsConfig.entityIdBullet, this, 250, 5, true);

        EntityRegistry
            .registerModEntity(PlaceableIcecream.class, "PlaceableIceCream", DCsConfig.entityIdIce, this, 250, 5, true);
        EntityRegistry
            .registerModEntity(PlaceableSteak.class, "PlaceableSteak", DCsConfig.entityIdSteak, this, 250, 5, true);
        EntityRegistry.registerModEntity(
            PlaceableAlcoholCup.class,
            "PlaceableAlcoholCup",
            DCsConfig.entityIdAlcohol,
            this,
            250,
            5,
            true);
        EntityRegistry.registerModEntity(
            PlaceableCocktail.class,
            "PlaceableCocktail",
            DCsConfig.entityIdCocktail,
            this,
            250,
            5,
            true);
        EntityRegistry.registerModEntity(
            PlaceableCocktail2.class,
            "PlaceableCocktail2",
            DCsConfig.entityIdCocktail2,
            this,
            250,
            5,
            true);
        EntityRegistry
            .registerModEntity(PlaceableBowl.class, "PlaceableBowl", DCsConfig.entityIdBowl, this, 250, 5, true);
        EntityRegistry
            .registerModEntity(PlaceableBowlJP.class, "PlaceableBowlJP", DCsConfig.entityIdBowlJP, this, 250, 5, true);
        EntityRegistry
            .registerModEntity(PlaceableCup1.class, "PlaceableCup", DCsConfig.entityIdCup, this, 250, 5, true);
        EntityRegistry
            .registerModEntity(PlaceableCup2.class, "PlaceableCup2", DCsConfig.entityIdCup2, this, 250, 5, true);
        EntityRegistry
            .registerModEntity(PlaceableTart.class, "PlaceableTart", DCsConfig.entityIdTart, this, 250, 5, true);
        EntityRegistry.registerModEntity(
            PlaceableSandwich.class,
            "PlaceableSandwich",
            DCsConfig.entityIdSandwich,
            this,
            250,
            5,
            true);
        EntityRegistry.registerModEntity(
            PlaceableCocktailSP.class,
            "PlaceableCocktailSP",
            DCsConfig.entityIdCocktailSP,
            this,
            250,
            5,
            true);
        EntityRegistry.registerModEntity(
            PlaceableBaseSoup.class,
            "PlaceableBaseSoup",
            DCsConfig.entityIdBaseSoup,
            this,
            250,
            5,
            true);
        ...
        net.minecraft.world.gen.structure.MapGenStructureIO
            .func_143031_a(ComponentVillageWarehouse.class, "ViWarehouse");
